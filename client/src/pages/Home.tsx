        ...
        <div className="max-w-7xl mx-auto relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-300 mb-8 max-w-2xl mx-auto">
              Discover delicious meals from local restaurants at discounted prices. Help reduce food waste while enjoying quality food.
            </p>
            {!user && (
              <motion.div
                initial={{ opacity: 0 }}
      ...
      <section className="py-16 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-white mb-4">Available Food</h2>
          ...
          {loading ? (
            ...
            <div className="text-center py-20">
              <p className="text-gray-400 text-xl">No listings available yet. Check back soon!</p>
            </div>
          ) : (
                ...
                >
                  <div className="flex items-start justify-between mb-4">
                    <div>
                      ...
                      <p className="text-sm text-gray-400">{listing.vendorId.name}</p>
                    </div>
                  ...
                  <div className="flex items-center gap-3 mb-4">
                    <div className="flex items-baseline gap-2">
                      ...
                      {listing.originalPrice && (
                        <span className="text-gray-500 line-through">${listing.originalPrice}</span>
                      )}
                    </div>
                    {listing.originalPrice && (
                  ...
                  <div className="space-y-2 text-sm">
                    <div className="flex items-center text-gray-400">
                      <span className="font-semibold text-white mr-2">Quantity:</span>
                      {listing.quantity}
                    </div>
                    <div className="flex items-center text-gray-400">
                      <span className="font-semibold text-white mr-2">Pickup:</span>
                      {listing.pickupTime}
                    </div>
                  </div>
                </motion.div>
